...
class Domain(models.Model):
    ...
    domainnameshort = models.CharField('Short domain name:', max_length=50, null=False, blank=False)
    domainnamelong = models.CharField('Long domain name (.local):', max_length=70, null=False, blank=False)
    admin = models.CharField('Domain admin username:', null=False, max_length=30, blank=False, default='administrator')
